...
const dictionaries: Dictionaries = {
  en: {
    ...
    popupRecent: "Recent",
    popupWorkflows: "Browse workflows",
    popupTopUsed: "Top used",
    popupSuggestions: "Quick picks",
    popupBrowseServices: "Browse services",
    popupReplay: "Replay",
    ...
    workflowShowAllSteps: "Show all steps",
    workflowCollapseSteps: "Collapse steps",
    ...
    helpMaxGroups: "Max custom groups",
    helpMaxWorkflows: "Max workflows",
    helpMaxServices: "Max services",
    helpMaxServicesPerGroup: "Max services per custom group",
    helpMaxHistoryItems: "Max history items per list",
  ...
  zh: {
    ...
    popupRecent: "最近使用",
    popupWorkflows: "浏览工作流",
    popupTopUsed: "高频服务",
    popupSuggestions: "快捷推荐",
    popupBrowseServices: "浏览服务",
    popupReplay: "重放",
    ...
    workflowShowAllSteps: "展开全部步骤",
    workflowCollapseSteps: "收起步骤",
    ...
    helpMaxGroups: "最大自定义分组数",
    helpMaxWorkflows: "最大工作流数",
    helpMaxServices: "最大服务数",
    helpMaxServicesPerGroup: "每个自定义分组最大服务数",
    helpMaxHistoryItems: "每个历史列表最大记录数",
